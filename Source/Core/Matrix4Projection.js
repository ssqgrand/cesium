...
const projectionCartesian4Scratch = new Cartesian4();
/**
...
Matrix4Projection.prototype.project = function (cartographic, result) {
  ...
  let vec4 = projectionCartesian4Scratch;
  const multiplier = this._radiansMultiplier;
...
Matrix4Projection.prototype.unproject = function (cartesian, result) {
  ...
  let vec4 = Cartesian4.fromElements(
    cartesian.x,
    cartesian.y,
    cartesian.z,
    1.0,
  ...
  const multiplier = 1.0 / (this._radiansMultiplier * vec4.w);
